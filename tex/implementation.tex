...
\begin{lstlisting}[caption=Babascript Client サービス部のソースコード例, label=code:babascriptux5fclientux5fservice]
...
\begin{lstlisting}[caption=Babascript Client 処理結果を返すメソッドの例, label=code:babascriptux5fclientux5fserviceux5freturnvalue]
