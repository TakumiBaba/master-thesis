...
人間の振る舞いや行動を部分的に取り入れ統合を実現している例として注目すべきものが、レシピや仕事のマニュアルである。
レシピは人間に対する指示書であり、プログラムの一種である。
...
また、仕事のマニュアルも同様である。
マニュアルはその時々で行うべき業務の手順やを定義したものであり、
人間はマニュアルを見たり覚えておくことによって、処理を実行する。
...
このように、人間の振る舞いや行動もプログラムのような記述方法で表現可能であることから、
...
人間が優れているのは知能だけではない。
人間の身体を利用することで可能な処理には、現在の計算機やセンサー・アクチュエータ技術では実現が困難な処理が多く存在する。
...
人間にしか出来ない処理や人間のほうが得意な処理と、計算機による処理を融合して記述できる環境を
実現することによって、新しいプログラミングの可能性を追求する。
