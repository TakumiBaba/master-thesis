...
この構文を人間への指示構文と名付け、この構文を実現させるためのプログラムと人間のインタラクション設計について述べる。
...
<!-- しかし、プログラムは基本的にコンピュータ上で実行されるものであり、 -->
...
<!-- もちろん、実際にプログラムを実行するのはコンピュータであるため、
人間への指示をP -->
...
### 記法の検討
<!-- ### 既存手法の踏襲 -->
<!-- 同じような記法とか、既存プログラミング言語での利用とかいう。 -->
<!-- ### 類似記法ほにゃららとか。 -->

<!-- 既存言語上で、npmとかの資源を利用するべき -->
<!-- そもそもプログラムなので、同じ記法でおｋ -->
<!-- 切り替えるためにも。 -->
