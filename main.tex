...
\jhyear  {26}                                   % 平成○年度
\jsyear  {2014}                                 % 西暦○年度
\jkeyword  {プログラミング環境、ヒューマンコンピュテーション, プログラミング, ヒューマンコンピュータインタラクション, ソーシャルコンピューティング}     % 論文のキーワード
...
\eyear  {2014}                                        % 西暦○年度
\ekeyword  {Programing environement, Human computation, Programming, Human computer interaction, Social computing}          % 論文のキーワード
